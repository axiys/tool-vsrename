...
namespace VSRename
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("This renames folders and files with an option to rename contents of the file (ignores .git/ .vs/ .svn/ .nuget/ packages/ obj/ bin/ paths)");
                Console.WriteLine(
        ...
        {
            Console.Write(".");
            if (path.Contains(".git") || path.Contains(".vs") || path.Contains(".svn") || path.Contains(".nuget") || path.Contains("packages") || path.Contains("obj") || path.Contains("bin")) return;
